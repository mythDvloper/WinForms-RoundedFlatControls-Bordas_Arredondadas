...
{
    [ToolboxItem(true)]
    [Description("Panel com bordas arredondadas e mudança de cor ao clicar")]
    public class RoundedPanelMouseClickColorChange : Panel
    {
        ...
        public RoundedPanelMouseClickColorChange()
        {
        ...
        {
            BackColor = Color.FromArgb(54, 85, 121);
        }

        private void RoundedPanel_MouseUp(object sender, MouseEventArgs e)
        {
            BackColor = Color.FromArgb(42, 59, 77);
        }
